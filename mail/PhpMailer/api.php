...
// Gizli CC eklemk istiyorsan Burayı birde mail gönderme kısmını aktif etmen gerekli.
			    ...
			    $mail->send();
				// Template
			    include 'mailFeedback.php';
			} catch (Exception $e) {
			    echo "Message could not be sent. Mailer Error: {$mail->ErrorInfo}";
			}
		}
	}else{
		echo "Mail Apide sorun var. Paramatre gönderilmedi, lütfen post ile bir parametre gönderin.";
